...
O_level =input("did you pass WAEC with 5 credit passes including Maths and English ?").title()
Sitting =int(input("Enter the number of sitting for your WAEC result"))
